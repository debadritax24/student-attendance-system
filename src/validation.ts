...
export const studentCreate = z.object({ rollNumber:z.string().min(1), enrollmentNumber:z.string().optional(), name:z.string().min(2), email:z.string().email().optional(), department:z.string().optional(), semester:z.number().int().positive().optional(), section:z.string().optional(), active:z.boolean().optional() });
